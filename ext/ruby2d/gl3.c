...
int R2D_GL3_Load_Pins() {
  ...
  //   "    if(b.y > 0) {"
  //   "      c = bc;"
  //   "      emitVertex(position, -gs_in[0].width + r.x, -gs_in[0].height - b.y);"
  //   "      emitVertex(position,  gs_in[0].width - r.x, -gs_in[0].height - b.y);"
  //   "      emitVertex(position, -gs_in[0].width + r.x, -gs_in[0].height);"
  //   "      emitVertex(position,  gs_in[0].width - r.x, -gs_in[0].height);"
  //   "      EndPrimitive();"
  //   "    }"
  //   "    c = c1;"
  ...
  //   "    if(r.x > 0) {"
  //   "      c = c1;"
  //   "      emitVertex(position, -gs_in[0].width,  gs_in[0].height - r.y);"
  //   "      emitVertex(position, -gs_in[0].width, -gs_in[0].height + r.y);"
  //   "      emitVertex(position, -gs_in[0].width + r.x,  gs_in[0].height - r.y);"
  //   "      emitVertex(position, -gs_in[0].width + r.x, -gs_in[0].height + r.y);"
  //   "      EndPrimitive();"
  //   "      if(b.x > 0) {"
  //   "        c = bc;"
  //   "        emitVertex(position, -gs_in[0].width - b.x,  gs_in[0].height - r.y);"
  //   "        emitVertex(position, -gs_in[0].width - b.x, -gs_in[0].height + r.y);"
  //   "        emitVertex(position, -gs_in[0].width,  gs_in[0].height - r.y);"
  //   "        emitVertex(position, -gs_in[0].width, -gs_in[0].height + r.y);"
  //   "        EndPrimitive();"
  ...
  //   "      emitVertex(position, -gs_in[0].width - b.x, -gs_in[0].height - b.y);"
  //   "      emitVertex(position, -gs_in[0].width,  gs_in[0].height + b.y);"
  //   "      emitVertex(position, -gs_in[0].width, -gs_in[0].height - b.y);"
  //   "      EndPrimitive();"
  //   "    }"
  ...
  //   "    c = c1;"
  //   "    float rad = pos.z / 2;"
  //   "    if(gs_in[0].border != 0 && smr > gs_in[0].border) {"
  //   "      smr = gs_in[0].border;"
  //   "    }"
  //   "    if(rad < smr) {"
  //   "      rad = smr;"
  ...
  //   "    emitOrthogonal(pos);"
  //   "    return;"
  //   "  } else if(gs_in[0].border == 0 || gs_in[0].border > 3) {"
  //   "    sms = 1.2;"
  //   "  } else {"
  //   "    sms = gs_in[0].border * 0.4;"
  //   "  }"
  ...
  //   "      c = c0 = vec4(bc.rgb, 0);"
  //   "      if(sm.y > 0) {"
  //   "        emitVertex(position, -gs_in[0].width + r.x, -gs_in[0].height - b.y - sm.y);"
  //   "        emitVertex(position,  gs_in[0].width - r.x, -gs_in[0].height - b.y - sm.y);"
  //   "      }"
  //   "      c = bc;"
  //   "      emitVertex(position, -gs_in[0].width + r.x, -gs_in[0].height - b.y + sm.y);"
  //   "      emitVertex(position,  gs_in[0].width - r.x, -gs_in[0].height - b.y + sm.y);"
  //   "    } else {"
  //   "      c = c0 = vec4(gs_in[0].color.rgb, 0);"
  //   "    }"
  //   "    if(sm.y > 0) {"
  //   "      emitVertex(position, -gs_in[0].width + r.x, -gs_in[0].height - sm.y);"
  //   "      emitVertex(position,  gs_in[0].width - r.x, -gs_in[0].height - sm.y);"
  //   "    }"
  //   "    c = c1;"
  //   "    emitVertex(position, -gs_in[0].width + r.x, -gs_in[0].height + sm.y);"
  ...
  //   "    if(b.x > 0) {"
  //   "      if(sm.x > 0) {"
  //   "        emitVertex(position, -gs_in[0].width - b.x - sm.x,  gs_in[0].height - r.y);"
  //   "        emitVertex(position, -gs_in[0].width - b.x - sm.x, -gs_in[0].height + r.y);"
  //   "      }"
  //   "      c = bc;"
  //   "      emitVertex(position, -gs_in[0].width - b.x + sm.x,  gs_in[0].height - r.y);"
  ...
  //   "    }"
  //   "    if(sm.x > 0) {"
  //   "      emitVertex(position, -gs_in[0].width - sm.x,  gs_in[0].height - r.y);"
  //   "      emitVertex(position, -gs_in[0].width - sm.x, -gs_in[0].height + r.y);"
  //   "    }"
  //   "    c = c1;"
  //   "    emitVertex(position, -gs_in[0].width + sm.x,  gs_in[0].height - r.y);"
  ...
  //   "  } else {"
  //   "    emitRotated(gl_in[0].gl_Position);"
  //   "  }"
  //   "}";
