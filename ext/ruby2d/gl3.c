...
int R2D_GL3_Load_Pins() {
  ...
  GLchar vertexSource[] =
    ...
    "vec2 normalisedRound(float round, float smoothy, float normalisedBorder, vec2 winSize) {"
    "  if(round <= smoothy * 2) {"
    "    round = 0;"
    "  } else if(round > normalisedBorder - smoothy && round < normalisedBorder + smoothy) {"
    "    round = normalisedBorder - smoothy;"
    "  }"
    "  return vec2(round / winSize.x, round / winSize.y);"
    "}"
    ...
    "    bn = sms;"
    "  }"
    "  vec2 rtl = normalisedRound(gs_in[0].radius.x, sms, bn, winSize);"
    "  vec2 rtr = normalisedRound(gs_in[0].radius.y, sms, bn, winSize);"
    "  vec2 rbl = normalisedRound(gs_in[0].radius.z, sms, bn, winSize);"
    "  vec2 rbr = normalisedRound(gs_in[0].radius.a, sms, bn, winSize);"
    "  vec4 c1 = gs_in[0].color;"
    "  bw = 1;"
    "  bc = gs_in[0].borderColor;"
    ...
    "      if(b.y >= rtr.y) {"
    "        if(rtr.x > 0) {"
    "          emitVertex(position,  gs_in[0].width + b.x - rtr.x,  gs_in[0].height + b.y + sm.y);"
    "        } else {"
    "          emitVertex(position,  gs_in[0].width + b.x + sm.x,  gs_in[0].height + b.y + sm.y);"
    "        }"
    "        if(rtl.x > 0) {"
    "          emitVertex(position, -gs_in[0].width - b.x + rtl.x,  gs_in[0].height + b.y + sm.y);"
    "        } else {"
    "          emitVertex(position, -gs_in[0].width - b.x - sm.x,  gs_in[0].height + b.y + sm.y);"
    "        }"
    "        c = bc;"
    ...
    "            emitVertex(position, -gs_in[0].width - b.x + sm.x,  gs_in[0].height + b.y - sm.y);"
    "          }"
    "          emitVertex(position,  gs_in[0].width + sm.x,  gs_in[0].height + sm.y);"
    "          emitVertex(position, -gs_in[0].width - sm.x,  gs_in[0].height + sm.y);"
    "          c = c1;"
    "          emitVertex(position,  gs_in[0].width - sm.x,  gs_in[0].height - sm.y);"
    "          emitVertex(position, -gs_in[0].width + sm.x,  gs_in[0].height - sm.y);"
    "        } else {"
    "          emitVertex(position, -gs_in[0].width - b.x + rtl.x,  gs_in[0].height + sm.y);"
    "          emitVertex(position,  gs_in[0].width + sm.x,  gs_in[0].height + sm.y);"
    "          c = c1;"
    "          emitVertex(position, -gs_in[0].width - b.x + rtl.x,  gs_in[0].height - sm.y);"
    "          emitVertex(position,  gs_in[0].width - sm.x,  gs_in[0].height - sm.y);"
    ...
    "            emitVertex(position, -gs_in[0].width - b.x + sm.x,  gs_in[0].height + b.y - sm.y);"
    "          }"
    "          emitVertex(position,  gs_in[0].width + b.x - rtr.x,  gs_in[0].height + sm.y);"
    "          emitVertex(position, -gs_in[0].width - sm.x,  gs_in[0].height + sm.y);"
    "          c = c1;"
    "          emitVertex(position,  gs_in[0].width + b.x - rtr.x,  gs_in[0].height - sm.y);"
    "          emitVertex(position, -gs_in[0].width + sm.x,  gs_in[0].height - sm.y);"
    ...
    "    } else {"
    "      c = vec4(c1.rgb, 0);"
    "      emitVertex(position,  gs_in[0].width - rtr.x,  gs_in[0].height + sm.y);"
    "      emitVertex(position, -gs_in[0].width + rtl.x,  gs_in[0].height + sm.y);"
    "      c = c1;"
    "      emitVertex(position,  gs_in[0].width - rtr.x,  gs_in[0].height - sm.y);"
    "      emitVertex(position, -gs_in[0].width + rtl.x,  gs_in[0].height - sm.y);"
    "      if(rtr.y >= sm.y) {"
    "        emitVertex(position,  gs_in[0].width - rtr.x,  gs_in[0].height - rtr.y);"
    "      }"
    "      if(rtl.y >= sm.y) {"
    "        emitVertex(position, -gs_in[0].width + rtl.x,  gs_in[0].height - rtl.y);"
    "      }"
    "    }"
    "    emitVertex(position, 0, 0);"
    "    EndPrimitive();"
    ...
    "      if(b.y >= rbr.y) {"
    "        if(rbr.x > 0) {"
    "          emitVertex(position,  gs_in[0].width + b.x - rbr.x, -gs_in[0].height - b.y - sm.y);"
    "        } else {"
    "          emitVertex(position,  gs_in[0].width + b.x + sm.x, -gs_in[0].height - b.y - sm.y);"
    "        }"
    "        if(rbl.x > 0) {"
    "          emitVertex(position, -gs_in[0].width - b.x + rbl.x, -gs_in[0].height - b.y - sm.y);"
    "        } else {"
    "          emitVertex(position, -gs_in[0].width - b.x - sm.x, -gs_in[0].height - b.y - sm.y);"
    "        }"
    "        c = bc;"
    ...
    "          emitVertex(position, -gs_in[0].width + sm.x, -gs_in[0].height + sm.y);"
    "        } else {"
    "          emitVertex(position, -gs_in[0].width - b.x + rbl.x, -gs_in[0].height - sm.y);"
    "          emitVertex(position,  gs_in[0].width + sm.x, -gs_in[0].height - sm.y);"
    "          c = c1;"
    "          emitVertex(position, -gs_in[0].width - b.x + rbl.x, -gs_in[0].height + sm.y);"
    "          emitVertex(position,  gs_in[0].width - sm.x, -gs_in[0].height + sm.y);"
    ...
    "            emitVertex(position, -gs_in[0].width - b.x + sm.x, -gs_in[0].height - b.y + sm.y);"
    "          }"
    "          emitVertex(position,  gs_in[0].width + b.x - rbr.x, -gs_in[0].height - sm.y);"
    "          emitVertex(position, -gs_in[0].width - sm.x, -gs_in[0].height - sm.y);"
    "          c = c1;"
    "          emitVertex(position,  gs_in[0].width + b.x - rbr.x, -gs_in[0].height + sm.y);"
    "          emitVertex(position, -gs_in[0].width + sm.x, -gs_in[0].height + sm.y);"
    ...
    "    } else {"
    "      c = vec4(c1.rgb, 0);"
    "      emitVertex(position,  gs_in[0].width - rbr.x, -gs_in[0].height - sm.y);"
    "      emitVertex(position, -gs_in[0].width + rbl.x, -gs_in[0].height - sm.y);"
    "      c = c1;"
    "      emitVertex(position,  gs_in[0].width - rbr.x, -gs_in[0].height + sm.y);"
    "      emitVertex(position, -gs_in[0].width + rbl.x, -gs_in[0].height + sm.y);"
    "      if(rbr.y >= sm.y) {"
    "        emitVertex(position,  gs_in[0].width - rbr.x, -gs_in[0].height + rbr.y);"
    "      }"
    "      if(rbl.y >= sm.y) {"
    "        emitVertex(position, -gs_in[0].width + rbl.x, -gs_in[0].height + rbl.y);"
    "      }"
    "    }"
    "    emitVertex(position, 0, 0);"
    "    EndPrimitive();"
    ...
    "      if(b.x >= rtr.x) {"
    "        if(rtr.y > 0) {"
    "          emitVertex(position,  gs_in[0].width + b.x + sm.x,  gs_in[0].height + b.y - rtr.y);"
    "        } else {"
    "          emitVertex(position,  gs_in[0].width + b.x + sm.x,  gs_in[0].height + b.y + sm.y);"
    "        }"
    "        if(rbr.y > 0) {"
    "          emitVertex(position, gs_in[0].width + b.x + sm.x,  -gs_in[0].height - b.y + rbr.y);"
    "        } else {"
    "          emitVertex(position, gs_in[0].width + b.x + sm.x,  -gs_in[0].height - b.y - sm.y);"
    "        }"
    "        c = bc;"
    ...
    "          emitVertex(position,  gs_in[0].width - sm.x, -gs_in[0].height + sm.y);"
    "        } else {"
    "          emitVertex(position,  gs_in[0].width + sm.x,  -gs_in[0].height - b.y + rbr.y);"
    "          emitVertex(position,  gs_in[0].width + sm.x,  gs_in[0].height + sm.y);"
    "          c = c1;"
    "          emitVertex(position,  gs_in[0].width - sm.x, -gs_in[0].height - b.y + rbr.y);"
    "          emitVertex(position,  gs_in[0].width - sm.x,  gs_in[0].height - sm.y);"
    ...
    "            emitVertex(position,  gs_in[0].width + b.x - sm.x, -gs_in[0].height - b.y + sm.y);"
    "          }"
    "          emitVertex(position,  gs_in[0].width + sm.x,  gs_in[0].height + b.y - rtr.y);"
    "          emitVertex(position,  gs_in[0].width + sm.x,  -gs_in[0].height - sm.y);"
    "          c = c1;"
    "          emitVertex(position,  gs_in[0].width - sm.x,  gs_in[0].height + b.y - rtr.y);"
    "          emitVertex(position,  gs_in[0].width - sm.x, -gs_in[0].height + sm.y);"
    ...
    "    } else {"
    "      c = vec4(c1.rgb, 0);"
    "      emitVertex(position,  gs_in[0].width + sm.x,  gs_in[0].height - rtr.y);"
    "      emitVertex(position,  gs_in[0].width + sm.x, -gs_in[0].height + rbr.y);"
    "      c = c1;"
    "      emitVertex(position,  gs_in[0].width - sm.x,  gs_in[0].height - rtr.y);"
    "      emitVertex(position,  gs_in[0].width - sm.x, -gs_in[0].height + rbr.y);"
    "      if(rtr.x >= sm.x) {"
    ...
    "      if(b.x >= rtl.x) {"
    "        if(rtl.y > 0) {"
    "          emitVertex(position, -gs_in[0].width - b.x - sm.x,  gs_in[0].height + b.y - rtl.y);"
    "        } else {"
    "          emitVertex(position, -gs_in[0].width - b.x - sm.x,  gs_in[0].height + b.y + sm.y);"
    "        }"
    "        if(rbl.y > 0) {"
    "          emitVertex(position, -gs_in[0].width - b.x - sm.x,  -gs_in[0].height - b.y + rbl.y);"
    "        } else {"
    "          emitVertex(position, -gs_in[0].width - b.x - sm.x,  -gs_in[0].height - b.y - sm.y);"
    "        }"
    "        c = bc;"
    ...
    "          emitVertex(position, -gs_in[0].width + sm.x, -gs_in[0].height + sm.y);"
    "        } else {"
    "          emitVertex(position, -gs_in[0].width - sm.x,  -gs_in[0].height - b.y + rbl.y);"
    "          emitVertex(position, -gs_in[0].width - sm.x,  gs_in[0].height + sm.y);"
    "          c = c1;"
    "          emitVertex(position, -gs_in[0].width + sm.x, -gs_in[0].height - b.y + rbl.y);"
    "          emitVertex(position, -gs_in[0].width + sm.x,  gs_in[0].height - sm.y);"
    ...
    "            emitVertex(position, -gs_in[0].width - b.x + sm.x, -gs_in[0].height - b.y + sm.y);"
    "          }"
    "          emitVertex(position, -gs_in[0].width - sm.x,  gs_in[0].height + b.y - rtl.y);"
    "          emitVertex(position, -gs_in[0].width - sm.x,  -gs_in[0].height - sm.y);"
    "          c = c1;"
    "          emitVertex(position, -gs_in[0].width + sm.x,  gs_in[0].height + b.y - rtl.y);"
    "          emitVertex(position, -gs_in[0].width + sm.x, -gs_in[0].height + sm.y);"
    ...
    "    } else {"
    "      c = vec4(c1.rgb, 0);"
    "      emitVertex(position, -gs_in[0].width - sm.x,  gs_in[0].height - rtl.y);"
    "      emitVertex(position, -gs_in[0].width - sm.x, -gs_in[0].height + rbl.y);"
    "      c = c1;"
    "      emitVertex(position, -gs_in[0].width + sm.x,  gs_in[0].height - rtl.y);"
    "      emitVertex(position, -gs_in[0].width + sm.x, -gs_in[0].height + rbl.y);"
    "      if(rtl.x >= sm.x) {"
